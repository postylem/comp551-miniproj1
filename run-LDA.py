...
def run_LDA_and_report(k_folds, features, target_label,decision_tresh):
    ...
    for i in range(0,2*k,2):
        ...
        y = predict( train_data_x, stats_logodds[0], stats_logodds[1],
                           stats_logodds[2], stats_logodds[3], stats_logodds[4], decision_tresh)
...
if __name__ == "__main__":
    ...
    run_LDA_and_report(k_folds, features,"quality",decision_tresh)
